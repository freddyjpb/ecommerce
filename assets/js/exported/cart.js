...
export const cart = {
  items: window.sessionStorage.getItem('cart') ? JSON.parse(window.sessionStorage.getItem('cart')) : [],
  methods: {
    add: (id, quantity) => {
...
export function renderCart () {
  ...
  window.sessionStorage.setItem('products', JSON.stringify(db.items))
  window.sessionStorage.setItem('cart', JSON.stringify(cart.items))
}
